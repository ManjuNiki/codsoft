...
root.config(bg='black')  # Set background color of the window
...
length_label = tk.Label(root, text="Password Length:", font=("Arial", 14), bg='black')
...
uppercase_check = tk.Checkbutton(root, text="Include Uppercase", variable=uppercase_var, font=("Arial", 12), bg='black')
uppercase_check.grid(row=1, column=0, columnspan=2, padx=10, pady=5)

lowercase_check = tk.Checkbutton(root, text="Include Lowercase", variable=lowercase_var, font=("Arial", 12), bg='black')
lowercase_check.grid(row=2, column=0, columnspan=2, padx=10, pady=5)

digits_check = tk.Checkbutton(root, text="Include Digits", variable=digits_var, font=("Arial", 12), bg='black')
digits_check.grid(row=3, column=0, columnspan=2, padx=10, pady=5)

special_check = tk.Checkbutton(root, text="Include Special Characters", variable=special_var, font=("Arial", 12), bg='black')
special_check.grid(row=4, column=0, columnspan=2, padx=10, pady=5)

# Generate password Button
generatepassword_button = tk.Button(root, text="Generate Password", font=("Arial", 14), bg="white", fg="black", command=generate_password)
generatepassword_button.grid(row=5, column=0, columnspan=2, pady=20)

# Display generated password
password_var = tk.StringVar()
password_label = tk.Label(root, text="Generated Password:", font=("Arial", 14), bg='black')
...
# Copy Button
copy_button = tk.Button(root, text="Copy", font=("Arial", 14), bg="green", fg="black", command=copy_password)
